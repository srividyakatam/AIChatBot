$(document).ready(function() {
    window.onload = function() {
      ...
      function sendMessage() {
        ...
        let selectedSubject = document.getElementById('subjectSelector').value;
        let selectedEduPersonality = document.getElementById('eduPersonality').value;
        let selectedEduSetting = document.getElementById('settingSelector').value;
        let selectedEduLevel = document.getElementById('subjectLevel').value;
        ...
        fetch('/educational_tutor_chat', {
          ...
          'edupersonality': selectedEduPersonality,
          'edu_setting': selectedEduSetting,
      ...
      function exportChat() {
        ...
        window.location.href = `/educational_tutor_export-chat/${serviceType}`;
    }
    ...
    document.getElementById('exportPromptButton').addEventListener('click', function() {
      let serviceType = document.getElementById('serviceType').value;
      window.location.href = `/educational_tutor_export-prompts/${serviceType}`;  });
